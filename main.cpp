//
// Created by Adam Hansson, adaha287, 950517-4517 on 2017-09-19.
//
...
int main() {
    ...
    double arrival_rate{2/exp(1)}; //Overall arrival rate
    ...
    bool pseudoBayesianStabilization = true; //Set to true to
    // enable pseudo-Bayesian stabilization
    ...
    for (int i{1}; i <= slots; ++i) {
        ...
        if(pseudoBayesianStabilization){
            q_r = bayesianProbability.getProbability(); //Get retransmitprobablility
        }
